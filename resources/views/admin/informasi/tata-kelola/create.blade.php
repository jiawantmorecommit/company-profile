        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-xl font-semibold text-gray-800">Create Informasi Tata Kelola</h2>
                    <a href="{{ route('admin.informasi.tata-kelola.index') }}" class="bg-gray-200 px-4 py-2 rounded-md text-gray-700 hover:bg-gray-300">Back</a>
                </div>
                ...
                <form action="{{ route('admin.informasi.tata-kelola.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="type" value="tata-kelola">
