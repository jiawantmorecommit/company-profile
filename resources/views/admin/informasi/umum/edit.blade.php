        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-xl font-semibold text-gray-800">Edit Informasi Umum</h2>
                    <a href="{{ route('admin.informasi.umum.index') }}" class="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition duration-150 ease-in-out">
                        Kembali
                    </a>
                </div>
                ...
                <form action="{{ route('admin.informasi.umum.update', $information->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        @if($information->images)
                            <div class="mt-2">
                                ...
                                <img src="{{ asset('storage/' . $information->images) }}" alt="{{ $information->title }}" class="h-24 w-auto mt-1">
                            </div>
                        @endif
